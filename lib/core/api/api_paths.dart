...
class ApiPaths {
  ...
  static const String updateUserProfile = baseURL + auth + "update-user-profile/";
  ...
  static const String userLatestAppointments = baseURL + auth + "user-latest-appointment/";
  ...
  static const String cancelUserAppointment = baseURL + auth + "cancel-user-appointment/";
  static const String bookUserAppointment = baseURL + auth + "save-frontend-appointment";
  static const String userNotifications = baseURL + "get-user-notification/";
  static const String removeUserNotifications = baseURL + "remove-user-notification/";
  ...
  static const String unLikeShop = baseURL + auth + "make-user-unfavorite-shop/";
  static const String getUserLikedShops = baseURL + auth + "user-favorite-shop/";
  ...
  static const String cityDeals = baseURL + "city-deal-list/";

  static const String searchService = baseURL + "s/";
  static const String nearMe ="/near-me/";

  // blogs
  static const String getSelectedCategories = baseURL + "get-selected-categories/";
